...
res_combo = cbind(fh_as_links[, c(1:6, 9:10)], ah_fs_links[, c(1, 2, 7, 8, 11)])
plot_cophylo(
    h_phy = fungus,
    s_phy = ants,
    results = res_combo,
...
colnames(res_combo)[1:2] = c("ParaFit_Host", "ParaFit_Symbiont")
colnames(res_combo)[9:10] = c("PACo_Host", "PACo_Symbiont")

write.table(res_combo, paste0('results/tables/', 'CombinedRes_PACo-AH-FS_ParaFit-FH-AS', '_coevo_global_results.txt'), sep = '\t', quote = FALSE, row.names = FALSE)
